...
class _AddCustomerState extends State<AddCustomer> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        elevation: 2,
        title: Text("Add Customer",style: MyTextTheme.bodyHead.copyWith(fontSize: 22)),
        leading: IconButton(
          onPressed: (){
            Get.back();
          },
                ...
                Row(
                  ...
                  children: [
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: (){
                        _invoiceController.addCustomer(_formKey);
                      },
                      ...
                      child:  Text("Add",style: MyTextTheme.bodyText.copyWith(fontSize: 16),),
                    ),
                  ),
                  ],
                ),
